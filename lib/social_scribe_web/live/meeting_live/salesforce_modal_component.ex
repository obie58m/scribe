defmodule SocialScribeWeb.MeetingLive.SalesforceModalComponent do
  @moduledoc """
  LiveComponent for the Salesforce CRM update modal on the meeting detail page.

  Manages the full workflow: contact search -> AI suggestion generation ->
  selective field update -> Salesforce API write. Delegates API calls to the
  parent LiveView via `send(self(), ...)` to keep the component stateless
        ...
        <% else %>
          <form phx-submit="apply_updates" phx-change="toggle_suggestion" phx-target={@myself}>
            ...
            <.modal_footer
              ...
              submit_class="bg-[#0176D3] hover:bg-[#014486]"
